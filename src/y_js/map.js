...
const MAP_POINTS = [
    ...
    { id: 'Programming',        x: 55,   z: -16, iconSvg: '../assets/icons/power.svg',  desc: 'Introduction to programming concepts, algorithmic logic, and writing your first Python code.' },
    { id: 'Variables',          x: 32,   z: -4,  iconSvg: '../assets/icons/var.svg',    desc: 'Learn how to declare variables, store values in memory, and work with core Python data types.' },
