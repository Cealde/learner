  ...
  '1_1_2': {
    ...
    questions: [
      ...
      },
      {
        ...
        code: "instruction_1()\ninstruction_2()\n# ലളിതമായ പടികൾ മിന്നൽ വേഗത്തിൽ ആവർത്തിക്കുന്നു.",
        options: [
  ...
  '1_1_4': {
    ...
    questions: [
      ...
      },
      {
        ...
        code: "# തെറ്റ് എന്താണെന്ന് പരിശോധിക്കുന്നു\nprint(\"Investigate!\")",
        options: [
      ...
      },
      {
        ...
        code: "score = 100\nname = \"Alex\"\nprint(score)\n# print(score)-ൽ ബ്രേക്ക്പോയിൻ്റ് ഇടുക",
        options: [
        ...
        explanation_correct: "<strong>⏸️ ശരിയായ ഉത്തരം!</strong><br/>ബ്രേക്ക്പോയിൻ്റ് പ്രോഗ്രാം താൽക്കാലികമായി നിർത്തി പരിശോധിക്കാൻ സഹായിക്കുന്നു.",
