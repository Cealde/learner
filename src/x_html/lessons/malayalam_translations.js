...
export const MALAYALAM_LESSON_DATA = {
  ...
  "1_3_5": {
      ...
      "description": "<strong>യഥാർത്ഥ അൽഗോരിതം: 2D യൂക്ലിഡിയൻ ഡിസ്റ്റൻസ്</strong><br/>ഗെയിം ഫിസിക്സ്, കൊളീഷൻ ഡിറ്റക്ഷൻ, റോബോട്ടിക്സ്, നാവിഗേഷൻ എഞ്ചിനുകൾ (Google Maps & A* pathfinding) എന്നിവയിൽ രണ്ട് പോയിന്റുകൾ <code>(x1, y1)</code>, <code>(x2, y2)</code> തമ്മിലുള്ള നേർരേഖാ ദൂരം കണ്ടെത്താൻ ഡിസ്റ്റൻസ് ഫോർമുല ഉപയോഗിക്കുന്നു:<br/><br/><strong>ഗണിത ഫോർമുല:</strong><br/><div class=\"math-formula-box\" style=\"margin: 8px 0; padding: 10px 18px; background: #0d1117; color: #fde047; border: 2px solid #000; border-radius: 6px; font-family: 'Cambria Math', 'Times New Roman', serif; font-size: 1.3rem; letter-spacing: 0.5px; display: inline-block;\"><em>distance</em> = &radic;<span style=\"text-decoration: overline;\">(<em>x</em><sub>2</sub> &minus; <em>x</em><sub>1</sub>)<sup>2</sup> + (<em>y</em><sub>2</sub> &minus; <em>y</em><sub>1</sub>)<sup>2</sup></span></div><br/><br/><strong>ചലഞ്ച്:</strong><br/>മുകളിലെ കോർഡിനേറ്റ് വേരിയബിളുകൾ ലോക്ക് ചെയ്തിരിക്കുന്നു. ഈ ഗണിത ഫോർമുലയെ കൃത്യമായ പൈത്തൺ കോഡാക്കി മാറ്റി <code>distance</code> കണക്കാക്കുക.<br/><br/><em>സൂചന:</em> പൈത്തണിൽ പവറുകളും വർഗ്ഗമൂലവും എങ്ങനെ എഴുതാമെന്ന് ഓർക്കുക. കണക്കുകൂട്ടലുകൾ ശരിയായ ക്രമത്തിൽ നടക്കാൻ ബ്രാക്കറ്റുകൾ <code>()</code> ശ്രദ്ധയോടെ ഉപയോഗിക്കുക!",
